...
#define PanSource	"verification.pml"
...
#define _nstates3	21	/* SEM6_cond0 */
#define minseq3	43
#define maxseq3	62
#define _endstate3	20

#define _nstates2	11	/* SEM4_var0 */
#define minseq2	33
#define maxseq2	42
#define _endstate2	10

#define _nstates1	11	/* SEM3_1_var0 */
#define minseq1	23
#define maxseq1	32
#define _endstate1	10

#define _nstates0	24	/* main */
#define minseq0	0
#define maxseq0	22
...
typedef struct State {
	...
	#endif
#endif
	int true_count_cond0;
	int false_count_cond0;
	int init_count_var0;
	int use_count_var0;
#ifdef TRIX
...
#define HAS_TRACK	0
/* hidden variable: */	uchar isdef_cond0;
/* hidden variable: */	uchar isdef_var0;
/* hidden variable: */	int cond0;
/* hidden variable: */	int init_count_cond0;
/* hidden variable: */	int use_count_cond0;
/* hidden variable: */	int destroy_count_cond0;
/* hidden variable: */	int var0;
/* hidden variable: */	int destroy_count_var0;
/* hidden variable: */	int true_count_var0;
/* hidden variable: */	int false_count_var0;
